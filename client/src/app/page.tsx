            ...
            <div className="flex flex-col lg:flex-row items-center justify-between space-y-12 lg:space-y-0 lg:space-x-12">
              <div className="space-y-8 lg:text-left">
                ...
                <p className="mx-auto lg:mx-0 max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                  Stream offers blockchain-powered tweet promotion campaigns with unparalleled transparency and accountability.
                </p>
            ...
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="mx-auto max-w-[600px] text-blue-100 md:text-xl">
                  Join Stream today and experience the future of transparent, accountable tweet promotions.
                </p>
              </div>
      ...
      <footer className="w-full py-6 bg-gray-800 text-white">
        <div className="container px-4 md:px-6">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
            <div>
              <h3 className="text-lg font-semibold mb-2">About Stream</h3>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">© 2024 Stream. All rights reserved.</p>
